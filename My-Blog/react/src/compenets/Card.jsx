...
export default function Card({ title, description, imagePath ,id }) {
  return (
    <div class="flex justify-center sm:justify-start">
      
  <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"></div>
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="w-full h-48 object-cover object-center" src={imagePath} alt="" />
    </a>
    <div className="p-5">
        <a href="#">
