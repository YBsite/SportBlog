    ...
    <div class="container mx-auto px-4">
        <form action="/blog" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            ...
            <select class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="category" name="category">
